...
class AdminController extends \EasyCorp\Bundle\EasyAdminBundle\Controller\AdminController
{
    ...
    protected function createNewForm($entity, array $entityProperties)
    {
        if (isset($this->entity['new']['form_type'])) {
            return $this->get('form.factory')->createNamed('easyadmin', $this->entity['new']['form_type'], $entity);
        }
        if (isset($this->entity['edit']['form_type'])) {
            return $this->get('form.factory')->createNamed('easyadmin', $this->entity['edit']['form_type'], $entity);
        }
